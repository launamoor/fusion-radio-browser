...
const Menu = function () {
  return (
    <nav className="flex flex-col items-stretch gap-4 mb-12 self-stretch">
      <MenuItem
        to="/"
        className="flex items-start justify-center xs:justify-start gap-4 menu-item text-3xl sm:text-xl font-semibold"
      >
      ...
      <MenuItem
        to="/saved"
        className="flex items-start justify-center xs:justifgy-start gap-4 menu-item text-3xl sm:text-xl font-semibold"
      >
